...
\tikzstyle{every node}=[font=\scriptsize]
  ...
  \node (rec9) [draw, right=2cm of rec3,yshift=1.5cm,thick,minimum width=5cm,minimum height=1.5cm,align=center]{Scheduler handling $a$ \\ $t^{ex}_a = select\_date(a)$};
...
\end{tikzpicture}
\end{adjustwidth}
\caption{\small Early decision making approach}\label{fig:obs}
\end{figure}
